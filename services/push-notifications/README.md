...
| `HARBOR_NOTIFICATIONS_GRPC_ADDR` | `0.0.0.0:3001` | Address the gRPC `NotificationService` listens on. |
| `HARBOR_EXPO_ACCESS_TOKEN` | _(unset)_ | Expo access token; blank is treated as unset. Only needed for projects with enhanced push security. |
